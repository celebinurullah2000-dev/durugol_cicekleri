...
class DevamsizlikScreen extends StatefulWidget {
  ...
  const DevamsizlikScreen({super.key, required this.classId});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          isScrollable: true, // 3 sekme olduğu için ekrana rahat sığması adına
          tabs: const [
            Tab(icon: Icon(Icons.edit_calendar), text: "Yoklama Al"),
            Tab(icon: Icon(Icons.history), text: "Geçmiş Raporu"),
            Tab(
              icon: Icon(Icons.pie_chart),
              text: "Öğrenci Bazlı Özet",
            ), // 3. Sekme
          ],
        ),
      ),
        ...
        children: [
          ...
          FutureBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  var data =
                      devamsizlikDocs[index].data() as Map<String, dynamic>;
          ...
          FutureBuilder<QuerySnapshot>(
            future:
                ...
                ), // Öğrenci snapshot'ını döndürüyoruz
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Center(child: CircularProgressIndicator());
              }
              ...
              if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                return const Center(
                  child: Text("Bu sınıfta öğrenci bulunmuyor."),
                );
              }
              ...
              return FutureBuilder<QuerySnapshot>(
                ...
                builder: (context, devamsizlikSnapshot) {
                  ...
                  // Her öğrencinin devamsızlık sayısını hesaplayalım: studentId -> toplam gün
